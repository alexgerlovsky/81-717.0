...
function ENT:InitializeSystems()
    ...
    self:LoadSystem("Electric","81_714_MMZ_Electric")
    ...
    self:LoadSystem("YAR_15A_MMZ")
    self:LoadSystem("YAR_27")
    self:LoadSystem("YAK_36_MINSK")
    self:LoadSystem("YAK_37E_MINSK")
    ...
    self:LoadSystem("Panel","81_714_Panel_Minsk")
    -- Пневмосистема 81-710
    self:LoadSystem("Pneumatic","81_717_MMZ_Pneumatic",{br013_1 = true})
    -- Everything else
    self:LoadSystem("Battery")
    self:LoadSystem("PowerSupply","BPSN_MINSK")
