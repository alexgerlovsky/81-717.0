...
--------------------------------------------------------------------------------
Metrostroi.DefineSystem("81_717_0_Pneumatic")
...
function TRAIN_SYSTEM:Think(dT)
    ...
    Train.AVT:TriggerInput("Open", self.BrakeCylinderPressure > 2.0) -- 1.8 - 2.0 --FIXed by Ben Evans
    Train.AVT:TriggerInput("Close",self.BrakeCylinderPressure < 1.5) -- 0.9 - 1.5
