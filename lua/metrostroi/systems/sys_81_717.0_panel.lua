...
--------------------------------------------------------------------------------
Metrostroi.DefineSystem("81_717_0_Panel")
...
function TRAIN_SYSTEM:Initialize()
	...
	self.Train:LoadSystem("KB1","Relay","Switch", {bass = true})
    self.Train:LoadSystem("KB2","Relay","Switch", {bass = true})
	self.Train:LoadSystem("KVT","Relay","Switch", {bass = true})
	self.Train:LoadSystem("EPKb","Relay","Switch", {bass = true})
    self.Train:LoadSystem("ContVent","Relay","Switch", {bass = true})
    self.Train:LoadSystem("KRP","Relay","Switch", {bass = true})
    self.Train:LoadSystem("HTR","Relay","VA21-29", {bass = true})
    ...
    --Цепи автоведения
    self.Train:LoadSystem("RC2","Relay","Switch",{bass = true})
	...
	--Not used for 81-717
    self.Train:LoadSystem("AA","Relay","VA21-29")
    ...
    self.Train:LoadSystem("VAO","Relay","Switch", { bass = true })
    ...
    -- Переключатели и контакторы принудительной вентиляции
    ...
    --ThyristorController Relays
    self.Train:LoadSystem("RU","Relay","R3100")
    
    --ARS Relays
    self.Train:LoadSystem("RARS","Relay", "KPD-111", {bass=true})
...
function TRAIN_SYSTEM:Outputs()
    return { "V1","LUDS","RedLight2","RedLight1","Headlights1","Headlights2","EqLights","CabLights","EqLights","PanelLights","CabinLight","EmergencyLights","MainLights","DoorsLeft","DoorsRight","DoorsW","GreenRP","BrW","LKVP","RZP","BrT","LSN","Ring","SD","LST","LVD","LhRK","KVC","SD","TW18", "KT",
             "LKVD","LN","RS","AR04","AR0","AR40","AR60","AR70","AR80","LKV1","LKV2","M1_3","M4_7","M8",
             "AnnouncerPlaying","AnnouncerBuzz","VPR","LEKK"}
end
...
TRAIN_SYSTEM.AVMap = {
    ...
    "A47","A42","A71",
    "A41","A45","A58","A59","A43",
    "A31","A32","A13","A1","A20","A25","A66",
    "A30","A56","A65","A2","A3","A4","A5",
    "A6","A70","A14","A39","A28","A18","A22",
    "A8","A12","A16","A37","A38","A51","A24","A19",
    "A40","A80","A50","A52","AV2",
